...
public class LeftActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        char[][] thisFace = com.example.rubiksolver_controller.Storage.cube.get("left");
        for (int i=0;i<3;i++){
            for (int j=0;j<3;j++){
    ...
    public void changeColorLeft(int i, int j, Button btn) {
        ...
        com.example.rubiksolver_controller.Storage.cube.put("left",thisFace);
    }
    ...
    public void leftGoFront(View view){
        Intent intent = new Intent(this, com.example.rubiksolver_controller.FrontActivity.class);
        //intent.putExtra("cube",this.cube);
        startActivity(intent);
    }
